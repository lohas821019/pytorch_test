...
#看size
print(train_data_set.data.size())
print(train_data_set.targets.size())
...
test_x = Variable(torch.unsqueeze(test_data_set.data, dim=1).float(), requires_grad=False)
#requires_grad=False 不參與反向傳播,test data 不用做
test_y = test_data_set.targets
